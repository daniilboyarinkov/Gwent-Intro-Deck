export const BeyondScenes = () => {
  return (
    <div className='BeyondScenes'>
      <img draggable={false} src='/Card-Swiper/assets/logo.png' alt='' className='BeyondScenesLogo' />
      ...
      <div className='BeyondScenesPS'>
        ...
        <img draggable={false} src='/Card-Swiper/assets/cardLogo.png' alt='' className='BeyondScenesLogo' />
      </div>
    </div>
  )
}
